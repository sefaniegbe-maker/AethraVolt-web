        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
              驱动未来的<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-stone-300">能源大脑</span>
            </h1>
            <p className="text-xl text-stone-400 leading-relaxed max-w-2xl">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-stone-600 max-w-2xl mx-auto">端-边-云协同计算，构建高可靠、低延迟的智能能源网络。</p>
          </div>
          ...
          <div className="max-w-5xl mx-auto relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="bg-paper rounded-2xl p-8 border border-stone-200 shadow-sm relative"
              >
                ...
                <ul className="space-y-3 text-stone-600 text-sm">
                  <li className="flex items-center gap-2"><Activity className="w-4 h-4 text-accent" /> 毫秒级数据采集</li>
                  <li className="flex items-center gap-2"><Activity className="w-4 h-4 text-accent" /> 本地实时控制策略</li>
                  <li className="flex items-center gap-2"><Activity className="w-4 h-4 text-accent" /> 离线自治运行能力</li>
                  <li className="flex items-center gap-2"><Activity className="w-4 h-4 text-accent" /> 硬件级安全防护</li>
                </ul>
              </motion.div>
              ...
              <motion.div 
                ...
                className="bg-ink text-white rounded-2xl p-8 border border-stone-800 shadow-xl relative transform md:-translate-y-4"
              >
                ...
                <ul className="space-y-3 text-stone-300 text-sm">
                  <li className="flex items-center gap-2"><Brain className="w-4 h-4 text-accent" /> 深度强化学习模型</li>
                  <li className="flex items-center gap-2"><Brain className="w-4 h-4 text-accent" /> 多目标优化算法</li>
                  <li className="flex items-center gap-2"><Brain className="w-4 h-4 text-accent" /> 负荷与价格预测</li>
                  <li className="flex items-center gap-2"><Brain className="w-4 h-4 text-accent" /> 联邦学习隐私保护</li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <ul className="space-y-3 text-stone-600 text-sm">
                  <li className="flex items-center gap-2"><Database className="w-4 h-4 text-accent" /> 海量数据湖存储</li>
                  <li className="flex items-center gap-2"><Database className="w-4 h-4 text-accent" /> 全局策略下发</li>
                  <li className="flex items-center gap-2"><Database className="w-4 h-4 text-accent" /> 跨站点协同调度</li>
                  <li className="flex items-center gap-2"><Database className="w-4 h-4 text-accent" /> 模型持续迭代训练</li>
                </ul>
              </motion.div>
            </div>
            
            {/* Connecting Lines (Visible on md+) */}
            <div className="hidden md:block absolute top-1/2 left-[20%] right-[20%] h-0.5 bg-gradient-to-r from-blue-200 via-accent to-purple-200 -z-0"></div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="bg-white p-4 rounded-xl border border-stone-200 flex items-start gap-4">
            ...
            <div className="relative">
              <div className="aspect-square rounded-full border border-stone-200 absolute inset-0 animate-[spin_60s_linear_infinite]"></div>
              <div className="aspect-square rounded-full border border-stone-200 absolute inset-8 animate-[spin_40s_linear_infinite_reverse]"></div>
              <div className="aspect-square rounded-full border border-stone-200 absolute inset-16 animate-[spin_20s_linear_infinite]"></div>
              
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-32 h-32 bg-accent rounded-full shadow-2xl shadow-accent/30 flex items-center justify-center text-white z-10">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-stone-600 max-w-2xl mx-auto">从数据感知到自主决策的完整闭环。</p>
          </div>

          <div className="max-w-4xl mx-auto">
            <div className="relative border-l-2 border-stone-200 ml-4 md:ml-0 md:left-1/2 md:-translate-x-1/2 space-y-12">
              {[
                ...
                <div key={i} className={`relative flex items-center md:w-1/2 ${i % 2 === 0 ? 'md:ml-auto md:pl-8' : 'md:mr-auto md:pr-8 md:justify-end'}`}>
                  <div className="absolute left-[-9px] md:left-auto md:right-[-9px] w-4 h-4 rounded-full bg-accent border-4 border-white shadow-sm z-10"></div>
                  <div className={`bg-paper p-6 rounded-2xl border border-stone-200 w-full ml-6 md:ml-0 ${i % 2 === 0 ? '' : 'md:text-right'}`}>
                    <span className="text-accent font-mono font-bold text-sm mb-2 block">STEP {item.step}</span>
      ...
      <section className="py-24 bg-ink text-white overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-stone-400 max-w-2xl mx-auto">动态响应市场价格与电网需求，实现价值最大化。</p>
          </div>

          <div className="max-w-5xl mx-auto bg-stone-800 rounded-3xl p-8 border border-stone-700 shadow-2xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-6 text-accent">动态套利与需量管理</h3>
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-stone-400 text-sm">系统自动识别电价低谷，控制储能系统满功率充电，储备廉价电能。</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-stone-400 text-sm">在电价高峰期，储能系统放电供负载使用，减少从电网购买高价电。</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-stone-400 text-sm">实时监测企业总负荷，当逼近申报需量时，储能紧急放电削峰，避免高额需量电费罚款。</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Chart Visualization */}
              <div className="bg-ink rounded-xl p-6 border border-stone-700 relative">
                <div className="flex justify-between items-center mb-6">
                  <span className="text-sm text-stone-400 font-mono">24H 调度曲线模拟</span>
                  <div className="flex gap-2">
                    <span className="flex items-center gap-1 text-xs text-stone-400"><div className="w-2 h-2 bg-blue-500 rounded-full"></div>电价</span>
                    <span className="flex items-center gap-1 text-xs text-stone-400"><div className="w-2 h-2 bg-accent rounded-full"></div>储能动作</span>
                  </div>
                </div>
                ...
                <div className="h-48 relative flex items-end gap-1">
                  {Array.from({ length: 24 }).map((_, i) => {
                    ...
                    const actionColor = isLowPrice ? 'bg-blue-500' : isHighPrice ? 'bg-orange-500' : 'bg-stone-600';
                    ...
                    return (
                      <div key={i} className="flex-1 flex flex-col justify-end items-center gap-1 group relative">
                        {/* Tooltip */}
                        <div className="absolute -top-10 bg-stone-800 text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10">
      ...
      <section className="py-24 bg-ink text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Code / Terminal View */}
            <div className="bg-stone-900 rounded-xl border border-stone-800 overflow-hidden font-mono text-sm flex flex-col">
              <div className="bg-stone-800 px-4 py-2 flex items-center gap-2 border-b border-stone-800">
...
<span className="text-purple-400">while</span> <span className="text-orange-400">True</span>:
    ...
    <span className="text-blue-400">shadow_mode_evaluation</span>(active_model, updated_model, telemetry)
            ...
            {/* Features */}
            <div className="space-y-6">
              <div className="bg-stone-900 p-6 rounded-xl border border-stone-800 hover:border-accent/50 transition-colors">
