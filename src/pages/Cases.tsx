      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col gap-16">
          {casesData.map((item, index) => (
            <div key={item.id} className="flex flex-col bg-stone-900/20 border border-stone-800/60 rounded-3xl p-8 md:p-12 hover:border-stone-700 transition-colors duration-500">
              ...
              <div className="w-full flex flex-col">
                ...
                <p className="text-lg text-stone-400 mb-8 leading-relaxed font-light max-w-4xl">
                  {item.description}
                </p>
